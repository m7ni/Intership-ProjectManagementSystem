...
import pt.isec.pa.apoio_poe.model.data.Minor;
...
public class UIText {
    ...
    private void UnTieStateUI() {
        ...
        if(!fsm.studentTie(studentNumber))
            fsm.sameState();
...
*/
    ...
    private void editTeacher() {
        ...
        switch (PAInput.chooseOption("What do you wish to edit ?",
                "Name", "Email")) {
            case 1 -> fsm.setName(PAInput.readString("Email of the teacher that you wish to edit: ", true),email);
